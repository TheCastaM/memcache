...
int main() {
    ...
    sem_init(&semaforo, 0, 3); /*Comen hasta 4 a la vez*/
    int i;
...
/*
Esta solucion funciona ya que como a lo sumo N-1 comen, y hay N
tenedores, el tenedor que queda es el izquierdo de algun filosofo,
que podra comer y luego liberar sus recursos.
*/